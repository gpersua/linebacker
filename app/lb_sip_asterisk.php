...
class lb_sip_asterisk extends Model
{
    ...
    return DB::connection('main')->table('sipusers')->insert([
           ['name'=>$extension, 'defaultuser'=>$extension, 'port'=>5060, 'secret'=>$secret, 'context'=>'from-linebacker','HOST'=>'dynamic','nat'=>'force_rport,comedia','qualify'=>'no','TYPE'=>'friend','transport'=>'udp','dtmfmode'=>'rfc2833','directmedia'=>'no','callerid'=>$extension,'mailbox'=>$extension,'fromdomain'=>'voip.mylinebacker.net','fromuser'=>$extension,'qualify'=>'yes','qualifyfreq'=>60,'sippasswd'=>$secret],
        ]);
  }
