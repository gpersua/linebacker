...
@section('main-content')
    ...
    <h1>Create New Extension</h1>
    <hr/>

    {!! Form::open(['url' => 'admin/extension/store', 'class' => 'form-horizontal']) !!}
            ...
            <div class="form-group {{ $errors->has('userAcc') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::text('userAcc', Session::get('userAcc'), ['class' => 'form-control', 'required' => 'required']) !!}
