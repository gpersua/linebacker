...
@endif
		...
		<div class="box-footer">
                @if(Auth::check() && Auth::user()->is('admin'))<a class="btn btn-danger" href="{{ URL::to('users') }}">Cancel</a> @else
                <a class="btn btn-danger" href="{{ URL::to('users/account') }}">Cancel</a>@endif
